...
const TabButton: React.FC<{ active: boolean; onClick: () => void; label: string; icon: React.ReactNode }> = ({
  ...
  <button
    onClick={onClick}
    className={clsx(
      'group relative w-full md:w-auto min-w-[220px] px-6 py-4 rounded-xl font-semibold flex items-center justify-center gap-2 transition-all cursor-pointer',
            ...
            >
                {projects.map(p => (
                  <motion.div key={p.id} variants={item} className="h-full">
                    <CardShell className="h-full overflow-hidden flex flex-col">
                      {/* preview */}
                      ...
                      <div className="p-5 flex flex-col flex-1">
                        ...
                        <div className="flex items-center justify-between mt-auto">
                          ...
                          <button
                            ...
                            className="text-sm text-white/80 hover:text-purple-400 inline-flex items-center gap-1 px-3 py-1.5 rounded-md bg-white/5 border border-white/10 cursor-pointer"
                          >
        ...
        <AnimatePresence>
          {detail && (
            <motion.div
              ...
              exit={{ opacity: 0 }}
            >
              <div className="absolute inset-0 overflow-y-auto py-10 px-4">
